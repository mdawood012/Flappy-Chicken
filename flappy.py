...
try:
    import simplegui, random  # Works in CodeSkulptor
except ImportError:
    import SimpleGUICS2Pygame.simpleguics2pygame as simplegui  # Works in normal Python

#https://py3.codeskulptor.org/#user310_0ghZITdfMpwS114.py
